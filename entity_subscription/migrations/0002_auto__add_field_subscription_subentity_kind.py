...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.subentity_kind'
        db.add_column(u'entity_subscription_subscription', 'subentity_kind',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity.EntityKind'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.subentity_kind'
        db.delete_column(u'entity_subscription_subscription', 'subentity_kind_id')
